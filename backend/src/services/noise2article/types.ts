...
export const DEFAULT_CONFIG: PipelineConfig = {
  subreddits: [
    ...
    { name: 'MachineLearning', tier: 1, minScore: 10, minComments: 0 },
    { name: 'artificial', tier: 1, minScore: 10, minComments: 0 },
    ...
    { name: 'MLOps', tier: 2, minScore: 10, minComments: 0 },
    { name: 'ChatGPT', tier: 2, minScore: 10, minComments: 0 },
  ...
  'personal-finance': {
    ...
    configOverrides: {
      subreddits: [
        ...
        { name: 'CreditCards', tier: 2, minScore: 30, minComments: 0 },
        { name: 'ETFs', tier: 2, minScore: 30, minComments: 0 },
        { name: 'FinancialPlanning', tier: 2, minScore: 30, minComments: 0 },
  ...
  'health-wellness': {
    ...
    configOverrides: {
      subreddits: [
        ...
        { name: 'Biohackers', tier: 2, minScore: 20, minComments: 0 },
        { name: 'Supplements', tier: 2, minScore: 20, minComments: 0 },
        { name: 'bodyweightfitness', tier: 2, minScore: 30, minComments: 0 },
  ...
  'travel': {
    ...
    configOverrides: {
      subreddits: [
        ...
        { name: 'onebag', tier: 2, minScore: 20, minComments: 0 },
        { name: 'awardtravel', tier: 2, minScore: 20, minComments: 0 },
  ...
  'geopolitics': {
    ...
    configOverrides: {
      subreddits: [
        ...
        { name: 'WarCollege', tier: 2, minScore: 20, minComments: 0 },
  ...
  'hinduism': {
    ...
    configOverrides: {
      subreddits: [
        ...
        { name: 'sanskrit', tier: 2, minScore: 15, minComments: 0 },
        { name: 'Ayurveda', tier: 2, minScore: 20, minComments: 0 },
  ...
  'stock-market': {
    ...
    configOverrides: {
      subreddits: [
        ...
        { name: 'ETFs', tier: 2, minScore: 40, minComments: 0 },
        { name: 'thetagang', tier: 2, minScore: 30, minComments: 0 },
        { name: 'algotrading', tier: 3, minScore: 20, minComments: 10 },
